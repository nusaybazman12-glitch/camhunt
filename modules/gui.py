...
class CamHuntGUI:
    ...
    def show_my_network(self):
        ...
        if self.network_info:
            print(f"  🖥️  হোস্টনেম    : {self.network_info['hostname']}")
            print(f"  🌐 আপনার IP    : {self.network_info['local_ip']}")
            print(f"  📶 নেটওয়ার্ক    : {self.network_info['network_range']}")
        else:
    ...
    def option_scan(self):
        ...
        for i, d in enumerate(devices, 1):
            ...
            print(f"  │ {i:<2} │ {d['ip']:<15} │ {d['mac']:<17} │ {host:<20} │")
